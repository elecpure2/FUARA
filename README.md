...
한글/일본어 payload를 안전하게 보내려면 `python fuara_api.py POST /tasks --json-file payload.json` 같은 UTF-8 파일 기반 경로를 권장합니다.
...
| GET | `/projects/:id/worklog` | 프로젝트 작업일지 조회 |
| POST | `/projects/:id/worklog` | 프로젝트 작업일지 생성/업데이트 |
